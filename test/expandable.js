...
$.write('</form>');
$.write('</div>');
$.write('<div id="messages" style="border:1px #000000 solid; font-size:xx-small">
</div>');
...
function renderExpandedView(width, height, direction) {
 $.getElementById('messages').innerHTML += 'expanded: width=' + width + ',
height=' + height + ', direction=' + direction + '<br>';
}
function renderCollapsedView(width, height) {
 $.getElementById('messages').innerHTML += 'collapsed: width=' + width + ',
height=' + height + '<br>';
}
